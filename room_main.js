...
function applyCurrentSettings() {
    ...
    // OPTIMIZACIÓN EXTREMA: Escalado de resolución interna para móviles de gama baja
        ...
        if (node.isMesh) {
            ...
            if (isFoco || isFocoDia) {
                ...
                if(node.material) {
                    ...
                    // OPTIMIZACIÓN: DoubleSide cuesta el doble de FPS. Lo desactivamos obligatoriamente en modo "baja".
