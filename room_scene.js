...
export const SceneSetup = {
    ...
    init(gameSettings, isMobileUA) {
        ...
        const isBaja = gameSettings.calidad === 'baja';
        
        this.renderer = new THREE.WebGLRenderer({ 
            // Desactivamos antialias solo en baja para ganar mucho rendimiento en móviles viejos
            antialias: !isBaja, 
            powerPreference: "high-performance",
            // OPTIMIZACIÓN GAMA BAJA: Forzamos el uso de una precisión media de shaders para aliviar la GPU en modo Suave
            precision: isBaja ? 'mediump' : 'highp'
        });
